...
// 			}
// 			if stack[len(stack)-1] != tokenizer.TokenLeftBrace {
...
// 			if stack[len(stack)-1] == tokenizer.TokenComma || stack[len(stack)-1] == tokenizer.TokenLeftBrace || stack[len(stack)-1] == tokenizer.TokenRightBrace {
// 				stack = append(stack, tokenizer.TokenString)
// 			}
// 			if stack[len(stack)-1] == tokenizer.TokenColon {
// 				stack = stack[:len(stack)-1]
// 				if stack[len(stack)-1] != tokenizer.TokenString {
